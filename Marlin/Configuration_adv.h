...
#define HOMING_BUMP_DIVISOR { 5, 5, 6 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 */
  ...
  //#define EVENT_GCODE_TOOLCHANGE_T1 "G1 A10"       // Extra G-code to run while executing tool-change command T
